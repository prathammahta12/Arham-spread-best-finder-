...
# ==================== 2. ARHAM TRADERS TERMINAL (EXACT FILE CODE INTEGRATED) ====================
    ...
    * {{ box-sizing: border-box; }}
      ...
      box.innerHTML=lastResults.map((r,i)=>`
        <div class="result-card">
          <div class="card-header" onclick="toggleCompany('${r.symbol}')">
            ...
            <div class="badges"><span class="badge badge-blue">Ratio: ${{ $("ratio").value }}</span></div>
          </div>
          <div class="card-details">
            <div class="spread-group">
              <div class="spread-header"><span>Expiry: ${{ $("expiry").value }}</span></div>
    ...
    dashboard_html = dashboard_html.replace("{current_uname}", current_uname)
    dashboard_html = dashboard_html.replace("{current_token}", current_token)
