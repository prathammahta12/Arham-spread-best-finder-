...
async function saveSettingsChanges(){
  ...
  try{
    ...
    const resp=await fetch("https://pnigixgqdftajqkmuouf.supabase.co/rest/v1/users?id=eq."+currentUserId,{
      method:"PATCH",
      headers:{ "apikey":"USER_TOKEN_PLACEHOLDER", "Authorization":"Bearer USER_TOKEN_PLACEHOLDER", "Content-Type":"application/json" },
...
"""
    ...
    dashboard_html = dashboard_html.replace("USER_TOKEN_PLACEHOLDER", SUPABASE_KEY)
